...
\setitemize{itemsep=0.1mm,parsep=1pt,leftmargin=10pt}
...
and instance of type \texttt{U}. Argument names and record fields begin begin
...
For notational convenience, \texttt{x} can often replaced with an expression of
type \texttt{T}.
...
\begin{alltt}
\textrm{\textsc{Control}}\vspace{5pt}
break
continue
next
return
...
% FIXME: not yet supported in Bro
